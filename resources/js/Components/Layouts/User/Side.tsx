            ...
            <nav className="fixed top-0 z-50 w-full bg-white border-b border-gray-200">
                <div className="px-3 py-3 lg:px-5 lg:pl-3">
                    ...
                    <div className="flex items-center justify-start">
                        ...
                        <span className="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap">Assessment</span>
                    </div>
            ...
            <aside id="logo-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0" aria-label="Sidebar">
                <div className="h-full px-3 pb-4 overflow-y-auto bg-white">
                    <ul className="space-y-2 font-medium">
                        <li>
                            <Link style={{ color: (Selected == 'home') ? '#1A56DB' : '#1E1F1C' }} to="/" className="flex items-center p-2 rounded-lg group">
